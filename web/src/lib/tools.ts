...
export const TOOL_REGISTRY: ToolInfo[] = [
  ...
  { name: 'gau',          category: 'http', description: 'Fetch known URLs from AlienVault, Wayback, Common Crawl',
    ...
    checkCmd: 'gau --help' },
  { name: 'urlfinder',    category: 'http', description: 'PD high-speed passive URL collector (replaces gau/wayback when throttled)',
    installCmd: 'go install -v github.com/projectdiscovery/urlfinder/cmd/urlfinder@latest',
    installer: goTool('github.com/projectdiscovery/urlfinder/cmd/urlfinder@latest'),
    checkCmd: 'urlfinder -version' },
