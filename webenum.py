#!/usr/bin/env python3
"""
WebEnum - Advanced Web Enumeration Framework
...
class WebEnum:
    ...
    def run(self, skip_screenshots: bool = False, skip_portscan: bool = False, 
        ...
        Logger.header(f"WEBENUM: {self.domain}")
...
"""
    ...
    parser = argparse.ArgumentParser(description='WebEnum - Advanced reconnaissance')
